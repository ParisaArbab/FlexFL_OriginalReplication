...
print("Loading Mistral-Nemo tokenizer...")
...
print("Loading Mistral-Nemo model in BF16...")
...
def query(messages):
    ...
    # Normalize role names and merge consecutive messages of the same role.
    normalized = []
