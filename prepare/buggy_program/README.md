...
# Note
Methods of fixed version of buggy program are used to obtain ground truth and cannot access when localizing faults. Methods in `FlexFL/data/input/buggy_program` are in buggy version of buggy programs.